    ...
    public void process(byte[] data) {
        ...
        for (String to : emails) {
            ...
            if (article.getUpdateTime() == null) {
                message.setText("aFei的个人博客发布了新的文章，地址：" + websiteUrl + "/articles/" + articleId);
            } else {
//                message.setText("aFei的个人博客对《" + article.getArticleTitle() + "》进行了更新，地址：" + websiteUrl + "/articles/" + articleId);
            }
