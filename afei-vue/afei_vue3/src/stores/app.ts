  ...
  state: () => {
    return {
      themeConfig: {
        ...
        feature: true,
        gradient: {
          // color_1: '#24c6dc',color_2: '#5433ff', color_3: '#ff0099'
          color_1: '#03afe4',
          color_2: '#7c78c8',
          color_3: '#ff0099'
        },
        header_gradient_css: 'linear-gradient(130deg, #03afe4, #7c78c8 41.07%, #ff0099 76.05%)',
        background_gradient_style: {
          background: 'linear-gradient(130deg, #03afe4, #7c78c8 41.07%, #ff0099 76.05%)',
