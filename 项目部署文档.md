...
```shell
docker run -d -p 3306:3306 --restart=always -v /afei/mysql/log:/var/log/mysql -v /auroras/mysql/data:/var/lib/mysql -v /afei/mysql/conf:/etc/mysql/conf.d  -e MYSQL_ROOT_PASSWORD=密码  --name mysql mysql
```
